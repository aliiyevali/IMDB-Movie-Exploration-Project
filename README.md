...
To answer that question, let’s investigate scatter plots and correlation coefficients. Within our sample data, the calculated correlation coefficient between these two variables was 0.2 as shown in the picture above. This value suggests that the relationship within our sample is relatively weak. While the direction is positive, the relationship is not strong. We can observe from our scatter plot that there are instances where certain movies achieved substantial profits despite not being well-received by the audience. On the flip side, certain movies received substantial acclaim from audiences but generated less profit compared to other films that were already being surpassed by them in audience rankings. We delve more into that part in our Linear regression model.
